...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"a88a5d3d-2896-440a-9f03-e565537ead34\00", align 1
...
@__ApplicationConfig_android_package_name.0 = internal constant [21 x i8] c"com.companyname.app4\00", align 1
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 53, ; number_of_assemblies_in_apk
...
@__DSOCacheEntry_name.2 = internal constant [23 x i8] c"libmono-btls-shared.so\00", align 1
...
@__DSOCacheEntry_name.5 = internal constant [19 x i8] c"libmonosgen-2.0.so\00", align 1

; dso_cache
@dso_cache = local_unnamed_addr global [20 x %struct.DSOCacheEntry] [
	; 0
...
@assembly_store_bundled_assemblies = local_unnamed_addr global [53 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 8
